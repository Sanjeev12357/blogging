...
export default function Home() {
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="relative h-[75vh] w-full overflow-hidden bg-gradient-to-b from-indigo-900 via-purple-800 to-rose-800">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center px-4 text-center">
          <div className="animate-float backdrop-blur-sm bg-black/20 p-10 rounded-3xl border-2 border-white/10">
            <h1 className="font-heading mb-10 max-w-4xl text-6xl font-bold leading-relaxed tracking-wide text-white text-shadow-funky md:text-7xl lg:text-8xl">
              Thoughts, 
              <br />
              Stories 
              <br />
            ...
            <p className="font-body mb-14 max-w-2xl text-xl text-white md:text-2xl">
              Welcome to my personal corner of the internet where I share insights on technology, design, and life's
              adventures.
            </p>
            <Button size="lg" className="funky-btn text-xl px-8 py-7">
              Start Reading
            </Button>
          </div>
        </div>
      ...
      <main className="container mx-auto px-4 py-20">
        ...
        <section className="mb-24">
          <div className="mb-12 flex items-center justify-between">
            <h2 className="font-heading text-4xl font-bold text-primary text-shadow-funky md:text-5xl tracking-tight">Recent Posts</h2>
            <span className="text-secondary text-xl font-bold hover:underline transition-colors cursor-pointer">
              View all posts
            </span>
          </div>
              ...
              <Card key={post} className={`funky-card group overflow-hidden rounded-xl bg-white ${
                ...
                <div className="relative h-52 w-full overflow-hidden">
                  <div className={`flex h-full w-full items-center justify-center ${
                    ...
                    {post % 6 === 0 ? (
                      <svg xmlns="http://www.w3.org/2000/svg" width="120" height="120" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" className="text-blue-500">
                      ...
                      <svg xmlns="http://www.w3.org/2000/svg" width="120" height="120" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" className="text-purple-500">
                        <circle cx="13.5" cy="6.5" r="4.5"></circle>
                        <circle cx="7.5" cy="12.5" r="4.5"></circle>
                        <circle cx="16.5" cy="17.5" r="4.5"></circle>
                      </svg>
                    ) : post % 6 === 2 ? (
                      <svg xmlns="http://www.w3.org/2000/svg" width="120" height="120" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" className="text-emerald-500">
                      ...
                      <svg xmlns="http://www.w3.org/2000/svg" width="120" height="120" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" className="text-orange-500">
                      ...
                      <svg xmlns="http://www.w3.org/2000/svg" width="120" height="120" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" className="text-red-500">
                      ...
                      <svg xmlns="http://www.w3.org/2000/svg" width="120" height="120" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" className="text-teal-500">
                        <circle cx="12" cy="12" r="10"></circle>
                  ...
                  <Badge className={`absolute right-3 top-3 border-3 border-black text-black text-lg px-4 py-1 ${
                ...
                <CardContent className="p-6">
                  <div className="mb-3 flex items-center gap-3 text-base font-bold text-primary">
                  ...
                  <h3 className="font-heading mb-5 text-2xl font-bold leading-relaxed tracking-tight">
                  ...
                  <p className="font-body mb-4 text-muted-foreground text-lg leading-relaxed">
                    {
                      [
                ...
                <CardFooter className="flex items-center justify-between border-t-4 border-black p-6">
                  <div className="flex items-center gap-3">
                    <div className={`flex h-12 w-12 items-center justify-center rounded-full border-3 border-black overflow-hidden ${
                      post % 6 === 0 ? "bg-blue-400" :
                      post % 6 === 1 ? "bg-purple-400" :
                      post % 6 === 2 ? "bg-emerald-400" :
                      post % 6 === 3 ? "bg-orange-400" :
          ...
          <div className="mt-12 flex justify-center">
            <Link href="/posts">
              <Button variant="outline" size="lg" className="funky-btn group text-xl px-8 py-7">
                Load More
